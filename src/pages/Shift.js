  ...
  useEffect(() => {
    ...
    onAuthStateChanged(auth, async (currentUser) => {
      if (currentUser) {
        ...
        const docRef3 = doc(db, "Groups", groups.groupId, "groupInfo", "download",);
        ...
        <div className="mainApp">
          <div className='shiftPage'>
            ...
            <div className='downloadBox'>
              <Download Info={Info} loading={loading} link={link} uploadFile={uploadFile} downloadFile={downloadFile} file_reference={file_reference} message_reference={message_reference2} />
            </div>
